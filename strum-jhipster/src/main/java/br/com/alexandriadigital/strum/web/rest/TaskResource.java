...
import br.com.alexandriadigital.strum.service.TaskService;
...
public class TaskResource {
    ...
    @Timed
    public ResponseEntity<List<TaskDTO>> searchTasks(@RequestParam String query, @ApiParam Pageable pageable) {
